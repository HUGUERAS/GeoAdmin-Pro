...
GeoAdmin Pro e um sistema de administracao geoespacial para topografia, georreferenciamento e gestao de projetos rurais. O foco do produto e operar bem no campo e destravar a documentacao de clientes, imoveis e confrontantes sem espalhar os dados em varios sistemas.
...
- `Projetos`: lista, detalhe, status e atalhos operacionais
